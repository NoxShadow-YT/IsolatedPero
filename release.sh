...
if [[ -f "./installed" ]]; then
    ...
    echo -ne '#                   (5%)\r'
    curl -sSLo files.zip https://github.com/NoxShadow-YT/IsolatedPero/sources/release.zip >/dev/null 2>err.log
    echo -ne '###                 (15%)\r'
    # Add more download steps here if necessary
    ...
    unzip -qq files.zip
    echo -ne '########            (45%)\r'
    # Add more extraction steps here if necessary

    echo "Setting up IsolatedPero"
    # Add setup instructions here

    touch "./installed"
    echo "IsolatedPero installation completed"
fi
